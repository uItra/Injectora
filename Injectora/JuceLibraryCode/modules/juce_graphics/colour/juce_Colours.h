...
public:
    ...
    *   the appropriate colour. A non-case-sensitive search is made of the list of				*
	*	predefined colours, and if a match is found, that colour is returned.					*
	*	If no match is found, the colour passed in as the defaultColour parameter is returned.	*
    *********************************************************************************************/
