...
void LookAndFeel_V3::drawButtonBackground (Graphics& g, Button& button, const Colour& backgroundColour, bool isMouseOverButton, bool isButtonDown)
{
...
void LookAndFeel_V3::createTabTextLayout(const TabBarButton& button, float length, float depth, Colour colour, TextLayout& textLayout)
{
