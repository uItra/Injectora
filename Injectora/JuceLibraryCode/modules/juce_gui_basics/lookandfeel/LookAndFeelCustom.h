#ifndef JUCE_LOOKANDFEEL_CUSTOM_H_INCLUDED
#define JUCE_LOOKANDFEEL_CUSTOM_H_INCLUDED
...
*/
class JUCE_API  LookAndFeelCustom : public LookAndFeel_V2
{
public:
	LookAndFeelCustom();
	~LookAndFeelCustom();
...
#endif   // JUCE_LOOKANDFEEL_CUSTOM_H_INCLUDED
