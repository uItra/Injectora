...
bool LookAndFeelCustom::areScrollbarButtonsVisible()        { return false; }

void LookAndFeelCustom::drawStretchableLayoutResizerBar(Graphics& g, int /*w*/, int /*h*/, bool /*isVerticalBar*/,
...
void LookAndFeelCustom::drawConcertinaPanelHeader(Graphics& g, const Rectangle<int>& area,
...
void LookAndFeelCustom::drawTableHeaderBackground(Graphics& g, TableHeaderComponent& header)
{
...
int LookAndFeelCustom::getTabButtonOverlap(int /*tabDepth*/)            { return -1; }
int LookAndFeelCustom::getTabButtonSpaceAroundImage()                    { return 0; }

void LookAndFeelCustom::createTabTextLayout(const TabBarButton& button, float length, float depth,
...
void LookAndFeelCustom::drawTabButton(TabBarButton& button, Graphics& g, bool isMouseOver, bool isMouseDown)
{
...
void LookAndFeelCustom::drawTabAreaBehindFrontButton(TabbedButtonBar& bar, Graphics& g, const int w, const int h)
{
...
bool LookAndFeelCustom::areLinesDrawnForTreeView(TreeView&)
{
	return false;
}

int LookAndFeelCustom::getTreeViewIndentSize(TreeView&)
{
	return 20;
}

void LookAndFeelCustom::drawComboBox(Graphics& g, int width, int height, const bool /*isButtonDown*/,
...
void LookAndFeelCustom::drawLinearSlider(Graphics& g, int x, int y, int width, int height,
...
void LookAndFeelCustom::drawLinearSliderBackground(Graphics& g, int x, int y, int width, int height,
	float /*sliderPos*/,
	float /*minSliderPos*/,
	float /*maxSliderPos*/,
	const Slider::SliderStyle /*style*/, Slider& slider)
...
void LookAndFeelCustom::drawKeymapChangeButton(Graphics& g, int width, int height,
...
class LookAndFeelCustom_DocumentWindowButton : public Button
{
public:
	LookAndFeelCustom_DocumentWindowButton(const String& name, Colour c, const Path& normal, const Path& toggled)
...
private:
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(LookAndFeelCustom_DocumentWindowButton)
};
...
Button* LookAndFeelCustom::createDocumentWindowButton(int buttonType)
{
	...
	if (buttonType == DocumentWindow::closeButton)
	{
		...
		return new LookAndFeelCustom_DocumentWindowButton("close", Colour(0xffdd1100), shape, shape);
	}
	...
	if (buttonType == DocumentWindow::minimiseButton)
	{
		...
		return new LookAndFeelCustom_DocumentWindowButton("minimise", Colour(0xffaa8811), shape, shape);
	}
	...
	if (buttonType == DocumentWindow::maximiseButton)
	{
		...
		return new LookAndFeelCustom_DocumentWindowButton("maximise", Colour(0xff119911), shape, fullscreenShape);
	}
...
Path LookAndFeelCustom::getTickShape(const float height)
{
...
Path LookAndFeelCustom::getCrossShape(const float height)
{
	static const unsigned char pathData[]
